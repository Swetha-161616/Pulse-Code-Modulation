...
# Theory:
# Pulse Code Modulation:
PCM, a message signal is represented by a sequence of coded pulse, which
is accomplished by representing the signal in discrete form in both time
and amplitude
# Delta Modulation:
Delta modulation, an incoming
message signal is oversampled to
purposely increase the correlation
between adjacent samples of the
signal.
# Program:
```
# Pulse Code Modulation
...
![WhatsApp Image 2026-02-06 at 2 07 17 PM](https://github.com/user-attachments/assets/3b1e2d34-0b80-458c-8cf2-aa52898df496)
DM

![WhatsApp Image 2026-02-06 at 2 08 44 PM](https://github.com/user-attachments/assets/7832cdcb-6f20-48ce-a64b-133a1fbc8e56)
